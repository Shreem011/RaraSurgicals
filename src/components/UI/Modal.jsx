...
import portfolios from "../../assets/productsData";
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div className="w-11/12 max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5">
        ...
        <div>
          <h2 className="text-2xl font-bold text-headingColor font-[700] my-5">
            {portfolio.title}
          </h2>
          ...
          <div className="mt-5 flex items-center gap-3 flex-wrap">
            <h4 className="text-headingColor text-[18px] text-[700]">Info :</h4>
